...
//             <span className="text-sm font-semibold text-purple-700">#{i + 1} • {career.score} pts</span>
//           </div>
//         </div>
//         <h3 className="text-lg font-bold text-gray-800 mb-2">{career.title}</h3>
//         <p className="text-gray-600 text-sm mb-4">{career.reason}</p>
//         <button
//           onClick={() => handleEducationClick(career.title)}
//           className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white py-2 px-4 rounded-xl hover:from-purple-700 hover:to-blue-700 transition-all duration-200 flex items-center justify-center space-x-2"
//         >
